  ...
  return (
    <div className="bg-[rgb(255,255,255)]">
      ...
      <main className={`${totalImages === imagesLoaded ? 'opacity-100' : 'opacity-0'} transition-opacity duration-300 flex flex-col items-center justify-around`}>
        <div className="select-none relative flex pt-20 sm:pt-64 sm:pb-36 flex-col w-full  text-center">
          <div className="sm:text-5xl text-sm font-medium ">crafting pixels with purpose</div>
          <div className="sm:mt-4 text-xs sm:text-2xl text-neutral-400 relative lowercase mb-2">
            creative technologist / full stack dev
          </div>
        </div>
        <div className="grid sm:grid-cols-12 grid-rows-min gap-1 w-full p-1 sm:p-2 sm:gap-2 [&>*]:min-h-[50vw] sm:[&>*]:min-h-[30vw] [&>*]:cursor-pointer">
          <Link href="/work/#temporary forever" passHref legacyBehavior>
            <a className="sm:col-span-4 relative ">
          ...
          <Link href="/work/#temporary forever" passHref legacyBehavior>
            <a className="sm:col-span-8 relative">
          ...
          <Link href="/work/#the blue paradox" passHref legacyBehavior>
            <a className="sm:col-span-3 relative">
          ...
          <Link href="/work/#the blue paradox" passHref legacyBehavior>
            <a className="sm:col-span-9 relative">
              <Overlay data={tagMap['bp']} />
          ...
          <Link href="/work/#the3dapp" passHref legacyBehavior>
            <a className="sm:col-span-5 relative">
          ...
          <Link href="/work/#the3dapp" passHref legacyBehavior>
            <a className="sm:col-span-7 relative bg-white sm:block hidden">
              <Overlay data={tagMap['lm']} />
          ...
          <Link href="/work/#the3dapp" passHref legacyBehavior>
            <a className="relative bg-white sm:hidden">
              <Overlay data={tagMap['lm']} />
              <Image sizes="(max-width: 768px) 100vw, 33vw" alt='image' fill className="object-cover" src='/images/lava/1.webp' />
            </a>
          </Link>


          <Link href="/work/#aerobanquets" passHref legacyBehavior>
            <a className="sm:col-span-7  relative">
          ...
          <Link href="/work/#antibody club" passHref legacyBehavior>
            <a className="sm:col-span-6 relative">
